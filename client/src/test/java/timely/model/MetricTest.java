...
public class MetricTest {
    ...
    public void testJson() throws IOException {
        ...
        Metric m1 = Metric.newBuilder()
                ...
                .value(1,1.0)
                .build();
        System.out.println(mapper.writeValueAsString(m1)); // this will throw if problem with deserialization
