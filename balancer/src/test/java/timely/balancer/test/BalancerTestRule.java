...
public class BalancerTestRule extends TestWatcher {

    private static final Logger log = LoggerFactory.getLogger(BalancerTestRule.class);
    private TimelyProperties timelyProperties;
    private AccumuloClient accumuloClient;

    public BalancerTestRule(TimelyProperties timelyProperties, AccumuloClient accumuloClient) {
