...
public class Metric {
    ...
    public Metric(){ tags = new ArrayList<>(); }
    ...
    public void setTags(List<Tag> tags) {
        this.tags.addAll(ImmutableList.copyOf(tags));
    }
    public void addTag(Tag tag){ tags.add(new Tag(tag));}
    ...
    public static class Builder {
        Metric metric;
        private Builder(){ metric = new Metric();}
