...
public class TimelyTestRule extends TestWatcher {

    private static final Logger log = LoggerFactory.getLogger(TimelyTestRule.class);
    private TimelyProperties timelyProperties;
    private AccumuloClient accumuloClient;

    public TimelyTestRule(TimelyProperties timelyProperties, AccumuloClient accumuloClient) {
