...
public class SslHelper {
    ...
    public static SslContext getSslContext(SslProperties ssl) throws Exception {
        return getSslContextBuilder(ssl).build();
    }

    public static SslContextBuilder getSslContextBuilder(SslProperties ssl) throws Exception {
        KeyManagerFactory keyManagerFactory = getKeyManagerFactory(ssl);
        SslContextBuilder builder = ssl instanceof SslServerProperties ? SslContextBuilder.forServer(keyManagerFactory)
    ...
    public static KeyManager[] getKeyManagers(SslProperties ssl) {
        return getKeyManagerFactory(ssl).getKeyManagers();
    }

    public static KeyManagerFactory getKeyManagerFactory(SslProperties ssl) {
        try {
    ...
    public static KeyStore getKeyStore(SslProperties ssl) throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException {
    ...
    public static TrustManager[] getTrustManagers(SslProperties ssl) {
        TrustManagerFactory tmf = getTrustManagerFactory(ssl);
        return tmf.getTrustManagers();
    }

    public static TrustManagerFactory getTrustManagerFactory(SslProperties ssl) {
        try {
    ...
    public static KeyStore getTrustStore(SslProperties ssl) throws KeyStoreException, IOException, CertificateException, NoSuchAlgorithmException {
