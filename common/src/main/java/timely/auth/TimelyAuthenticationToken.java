...
public final class TimelyAuthenticationToken extends PreAuthenticatedAuthenticationToken {
    ...
    transient private Multimap<String,String> httpHeaders = null;
    ...
    public TimelyAuthenticationToken(TimelyPrincipal timelyPrincipal, Multimap<String,String> httpHeaders) {
        super(timelyPrincipal.getPrimaryUser().getName(), null);
    ...
    public TimelyAuthenticationToken(String subjectDn, Object clientCert, Multimap<String,String> httpHeaders) {
        super(SubjectIssuerDNPair.of(subjectDn).toString(), clientCert);
        if (httpHeaders == null) {
    ...
    public TimelyAuthenticationToken(String subjectDn, String issuerDn, Object clientCert) {
        super(SubjectIssuerDNPair.of(subjectDn, issuerDn).toString(), clientCert);
        if (clientCert instanceof X509Certificate) {
            this.clientCert = (X509Certificate) clientCert;
        }
