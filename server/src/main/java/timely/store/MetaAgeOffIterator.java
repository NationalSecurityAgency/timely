...
public class MetaAgeOffIterator extends WrappingIterator implements OptionDescriber {
    ...
    private void skipExpiredData() throws IOException {
        ...
        while (!done && super.hasTop()) {
            ...
            if (dataAge < this.minAgeOff) {
                ...
                long metricAgeOff = ageoffs.getOrDefault(metricName, defaultAgeOff);
                if (dataAge > metricAgeOff) {
    ...
    public IteratorOptions describeOptions() {
        return new IteratorOptions("metric-age-off", "Iterator that ages off meta entries for Timely metrics",
