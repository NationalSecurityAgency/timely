...
public class TabletMetadataView {
    ...
    public TabletMetadataView(TabletMetadataProperties tabletMetadataProperties) {
        this();
        this.disableTabletRowCheckFilter = tabletMetadataProperties.getDisableTabletRowCheckFilter();
    }
    ...
    public String toText(TimeUnit unit) {
        ...
        TabletSummary.Builder builder = computeSummary();
        if (disableTabletRowCheckFilter) {
            builder.disableTabletRowCheckFilter();
        }
        TabletSummary summary = builder.build();

        if (summary.totalTablets() == 0) {
            return "No results";
        }
