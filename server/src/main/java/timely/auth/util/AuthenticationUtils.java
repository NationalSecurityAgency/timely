...
public class AuthenticationUtils {
    ...
    public static TimelyAuthenticationToken getTimelyAuthentication(Authentication authentication,
        ...
        if (authentication instanceof TimelyAuthenticationToken) {
            ...
            if (clientCert == null) {
                ...
                TimelyUser timelyUser = new TimelyUser(
                        SubjectIssuerDNPair.of(clientCert.getSubjectDN().getName(), clientCert.getIssuerDN().getName()),
