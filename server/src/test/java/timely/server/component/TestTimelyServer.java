...
@Primary
@Component
public class TestTimelyServer extends TimelyServer {

    private static final Logger log = LoggerFactory.getLogger(TestTimelyServer.class);
    ...
    @Autowired
    public TestTimelyServer(ApplicationContext applicationContext, AccumuloClient accumuloClient, DataStore dataStore, DataStoreCache dataStoreCache,
    ...
    protected ChannelHandler setupHttpChannelHandler(MetaCache metaCache, TimelyProperties timelyProperties, HttpProperties httpProperties, SslContext sslCtx) {
        return new ChannelInitializer<SocketChannel>() {
            ...
            protected void initChannel(SocketChannel ch) {
                TestTimelyServer.super.setupHttpSocketChannel(ch, metaCache, timelyProperties, httpProperties, sslCtx);
    ...
    protected ChannelHandler setupTcpChannel() {
        return new ChannelInitializer<SocketChannel>() {
            ...
            @Override
            protected void initChannel(SocketChannel ch) {
                TestTimelyServer.super.setupTcpSocketChannel(ch);
    ...
    protected ChannelHandler setupUdpChannelHandler() {
        return new ChannelInitializer<DatagramChannel>() {
            ...
            protected void initChannel(DatagramChannel ch) {
                TestTimelyServer.super.setupUdpSocketChannel(ch);
