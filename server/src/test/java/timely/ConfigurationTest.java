...
public class ConfigurationTest {
    ...
    public void testMinimalConfiguration() throws Exception {
        ...
        EnvironmentTestUtils.addEnvironment(this.context, "timely.server.ip:127.0.0.1", "timely.server.tcp-port:54321",
                ...
                "timely.security.ssl.use-generated-keypair:true", "timely.metric-age-off[default]:7");
        context.refresh();
        ...
        assertEquals(1, config.getMetricAgeOff().size());
        assertTrue(config.getMetricAgeOff().containsKey("default"));
        assertTrue(7 == config.getMetricAgeOff().get("default"));
    }
