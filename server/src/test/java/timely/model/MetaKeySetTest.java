...
public class MetaKeySetTest {
    ...
    public void testToMutations() {
        ...
        List<Mutation> muts = mks.toMutations(ts);
        Mutation e1 = new Mutation("m:sys.cpu.user");
        e1.put("", "", ts, MetaKeySet.NULL_VALUE);
        Mutation e2 = new Mutation("t:sys.cpu.user");
        e2.put("tag1", "", ts, MetaKeySet.NULL_VALUE);
        e2.put("tag2", "", ts, MetaKeySet.NULL_VALUE);
        e2.put("tag3", "", ts, MetaKeySet.NULL_VALUE);
        Mutation e3 = new Mutation("v:sys.cpu.user");
        e3.put("tag1", "value1", ts, MetaKeySet.NULL_VALUE);
        e3.put("tag2", "value2", ts, MetaKeySet.NULL_VALUE);
        e3.put("tag3", "value3", ts, MetaKeySet.NULL_VALUE);
